		...
		switch (event.getType()) {
			case "payment_intent.succeeded":
				...
				if (intent != null) {
					...
					String shippingCostStr = intent.getMetadata().get("shippingCost");
					String discountStr = intent.getMetadata().get("discount");
					...
					if(shippingCostStr != null) order.setShippingCost(Long.parseLong(shippingCostStr));
					if(discountStr != null) order.setDiscount(Long.parseLong(discountStr));
